...
async function main() {
  // Wipe existing candidate so reseeding is idempotent.
  ...
  const profile = await prisma.candidateProfile.create({
    data: {
      ...
      headline:
        "Cornell Tech Connective Media M.S. — AI, product, and human-centered software",
      location: "New York, NY",
      email: "neilfjohnsonw@gmail.com",
      phone: null,
      linkedinUrl: "https://www.linkedin.com/in/dylan-johnson-restrepo",
      githubUrl: "https://github.com/dylanjohnsonrestrepo",
      portfolioUrl: null,
      school: "Cornell Tech",
      ...
      courses: {
        create: [
          {
            code: "INFO 5310",
            name: "Building Connected Devices",
            term: "Fall 2025",
            description:
              "Hands-on course on connected hardware/software systems, ML on edge devices, and HCI prototyping.",
            tags: "IoT, embedded, HCI, hardware, prototyping",
          },
          {
            code: "TECH 5900",
            name: "Product Studio",
            term: "Fall 2025",
            description:
              "Year-long client-driven product studio. Teams partner with a startup or enterprise to discover, design, and ship a product over two semesters.",
            tags: "product, discovery, client, design, startup, shipping",
          },
          {
            code: "INFO 6120",
            name: "Designing Technology for Social Impact",
            term: "Spring 2026",
            description:
              "Design and evaluate technology with attention to equity, accessibility, and downstream social impact.",
            tags: "HCI, design, ethics, social impact, accessibility",
          },
          {
            code: "CS 5780",
            ...
            term: "Spring 2026",
            description:
              "Foundations of supervised and unsupervised learning, model evaluation, and applied projects.",
            tags: "ML, AI, supervised learning, evaluation, projects",
          },
          {
            code: "INFO 5340",
            ...
            term: "Fall 2025",
            description:
              "Immersive UX, 3D interaction, and AR/VR prototyping.",
            tags: "AR, VR, immersive, 3D, UX, prototyping",
          },
          {
            code: "TECH 5210",
            name: "Conversations in the Studio (Fintech track)",
            term: "Spring 2026",
            description:
              "Industry-led sessions on fintech, capital markets, and applied AI in financial services.",
            tags: "fintech, financial services, AI, industry",
          },
        ],
      },
    },
  ...
  // Seed two example jobs so the UI has cards on first load.
  ...
  console.log("Seeded candidate profile:", profile.id);
  console.log("Seeded job:", job1.id, job1.title);
  console.log("Seeded job:", job2.id, job2.title);
}
